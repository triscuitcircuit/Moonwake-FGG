...
async function getAll(req, res) {
    ...
    let content = [
        ...
        str ? {"$MOAB_MONSTER_ATTRIBUTE.MOAB_DISPLAY_TEXT$": {[Op.substring]: "STR " + str_arr[0]}} : null // todo figure out how to get associated value properly:  "MOAB_MONSTER_ATTRIBUTE"."MOAB_DISPLAY_TEXT": invalid identifier
